...
private final By btnChooseHourCurrentDayDrugBy = By.xpath("//div[div/h2[contains(text(), 'תרופות')]]//td[@name='drugsCurrentDay']//button");
private final By btnChooseHourCurrentDayGeneralBy = By.xpath("//div[div/div/h2[contains(text(), 'הוראות')]]//td[@name='drugsCurrentDay']//button");
private final By boxCurrentHourForLiquidBy = By.xpath("//div[div/h2[contains(text(), 'תמיסות')]]//tr[@name='drugRow2'][td]/td[@colspan='8']//div[contains(@class,'timeLineInToday')]");
private final By boxCurrentHourForBloodProductBy = By.xpath("//div[div/h2[contains(text(), 'מוצרי דם')]]//tr[@name='drugRow2'][td]/td[@colspan='6']//div[contains(@class,'timeLineInToday')]");


private final By approvalDrugBy = By.xpath("//h2[contains(text(), 'תרופות ')]/parent::div/following-sibling::div//table//button[contains(@id, 'btnIsApproval')]");
private final By approvalGeneralBy = By.xpath("//h2[contains(text(), 'הוראות ')]/parent::div/parent::div/following-sibling::div//table//button[contains(@id, 'btnIsApproval')]");
private final By approvalLiquidBy = By.xpath("//h2[contains(text(), 'תמיסות ')]/parent::div/following-sibling::div//table//button[contains(@id, 'btnIsApproval')]");
private final By approvalBloodProductBy = By.xpath("//h2[contains(text(), 'מוצרי דם ')]/parent::div/following-sibling::div//table//button[contains(@id, 'btnIsApproval')]");
...
private final By btnVforLiquidBy = By.xpath("(//form[@name='popContentSolutionBagSizeCode']//button)[3]");
...
private void executeTwoStepApproval(By chooseHourBy, By approvalBy, String typeName) {
    ...
    for (int i = 0; i < chooseHourBtn.size(); i++) {
        ...
        List<WebElement> currentButtons = DriverManager.getInstance().findElements(chooseHourBy);
        ...
        if (currentButtons.size() > i && currentButtons.get(i).isEnabled()) {
            ...
            List<WebElement> currentApprovalBtns = DriverManager.getInstance().findElements(approvalBy);

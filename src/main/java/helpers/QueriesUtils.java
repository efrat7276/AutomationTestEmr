...
public class QueriesUtils {
  ...
  public static String getDetailsFirstPatient(int deptCode) {
    return "SELECT TOP 1 a.mispar_ishpuz, teudat_zeut FROM dbo.admission AS a " + 
   ...
   public static final String cancelAllWoundsForPatient =
            "EXEC sp_ClosePetza @MisparIshpuz = %s";
}
